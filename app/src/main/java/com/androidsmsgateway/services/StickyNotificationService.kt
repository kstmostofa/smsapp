package com.androidsmsgateway.services
...
import com.androidsmsgateway.MainActivity
import com.androidsmsgateway.R
...
class StickyNotificationService: Service() {
    ...
    private fun createNotification(): Notification {
        ...
        return builder
            .setContentTitle("Android SMS Gateway Listener")
            .setContentText("Android SMS Gateway is listening for sent and received SMS messages in the background.")
